...
4. Taps "Call Coordinator"
5. Phone dialer opens immediately with Linda's number
6. Sarah calls Linda

**Time elapsed:** <2 seconds from first tap to phone dialing.
...
3. Taps "Done"
4. Note auto-saves
5. Alert syncs to server
6. Linda receives email with alert details

**What Sarah thinks:** "Got help in seconds. No paperwork, just a quick note."

---

## Success Metrics

- Time to call: <2 seconds
- Forms before call: 0
- Coordinator response time: <5 minutes
- Sarah's confidence: "I can get help instantly"
