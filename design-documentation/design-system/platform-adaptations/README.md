...
- Haptics (Taptic Engine vs vibration)
- UI conventions (navigation bar vs app bar)

## Platform Files

- `ios.md` – iOS-specific adaptations
- `android.md` – Android-specific adaptations
- `web.md` – Web-specific adaptations (Phase 2)

---

**Next:** Review individual platform files for specific adaptations.
