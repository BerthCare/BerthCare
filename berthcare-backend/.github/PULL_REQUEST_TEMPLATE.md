...
- [ ] Review/testing gates run (lint, type-check, unit/integration as applicable)
- [ ] Docs/README updated and architecture diagram at `docs/architecture/architecture-diagram.drawio` (and exported image if applicable) updated if behavior changed
- [ ] Security scans/compliance considerations noted; secrets/PII kept out of code/logs
- [ ] Deployment verification plan and rollback path stated (link to runbook if applicable)
...
## Screenshots
<!-- Add before/after screenshots when applicable. Mark N/A for API changes. -->
